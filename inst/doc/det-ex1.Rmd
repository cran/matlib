...
(For $3 \times 3$ matrices, the determinant is the **volume** of a parallelepiped in 3D space.)
```{r}
A <- matrix(c(3, 1, 
              2, 4), nrow=2, byrow=TRUE)
A
...
There is a simple [visual proof of this fact about determinants](http://math.stackexchange.com/questions/29128/why-determinant-of-a-2-by-2-matrix-is-the-area-of-a-parallelogram)
